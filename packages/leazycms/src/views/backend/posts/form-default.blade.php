        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="card">
                   ...
                   <img src="data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(300)->generate(url('surat-keluar/'.$post->keyword))) }}">
                   <div class="btn-group">
                   <a href="data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(300)->generate(url('surat-keluar/'.$post->keyword))) }}" download="{{ $post->keyword }}-qr.jpg" class="btn btn-info btn-sm"> <i class="fa fa-download" aria-hidden></i> QR</a>
